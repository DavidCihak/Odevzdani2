...
public class MySQLConnection {
	...
	public static int getColumnNames(ResultSet rs) throws SQLException {
		...
		if (rs != null) {
			// vytvoøí objekt na základì metadat výsledkové sady
			ResultSetMetaData rsMetaData = rs.getMetaData();
			// Pomocí metody getColumn získáte poèet vrácených sloupcù
			numberOfColumns = rsMetaData.getColumnCount();
			// dá a vypíše názvy sloupcù, indexy sloupcù zaèínající od 1
			for (int i = 1; i < numberOfColumns + 1; i++) {
				String columnName = rsMetaData.getColumnName(i);
				System.out.print(columnName + ", ");
			}
		}
		// Umístí kurzor na nový øádek v konzoli
		System.out.println();
